...
- `customer-solution-narrative` - Turn product capabilities into a customer-facing solution story for sales, marketing, and customer success. Use when internal product thinking must become external value communication.
  - `skills/customer-solution-narrative/SKILL.md`
...
- `ideal-customer-profile` - Define an ICP that identifies which customers are most worth targeting, winning, and keeping. Use when you need sharper customer selection for product, GTM, or solution strategy.
...
- `product-deliverable-critique` - Critically review product artifacts for evidence gaps, logic jumps, scope creep, and execution ambiguity. Use when a deliverable looks polished but may be weak.
  - `skills/product-deliverable-critique/SKILL.md`
...
- `wps-feature-design` - Design WPS Project Management features across scenarios, flows, states, roles, and validation. Use when turning an opportunity into a solution skeleton.
  - `skills/wps-feature-design/SKILL.md`
- `wps-problem-opportunity-map` - Turn WPS Project Management demand lists into a structured problem and opportunity map. Use when many requests exist but priority and value are unclear.
  - `skills/wps-problem-opportunity-map/SKILL.md`
- `wps-project-management-strategy` - Frame product strategy for WPS Project Management across editions, target users, scenarios, and differentiation. Use when aligning direction before roadmap or solution work.
  - `skills/wps-project-management-strategy/SKILL.md`
- `wps-solution-evaluation` - Compare WPS Project Management solution options by user value, strategic fit, complexity, risk, and validation path. Use when multiple approaches compete.
...
- `wps-project-management-prd` - Write a WPS Project Management PRD with edition context, object rules, collaboration design, and validation plan. Use for major feature or initiative specs.
  - `skills/wps-project-management-prd/SKILL.md`
- `wps-quarter-roadmap` - Build a quarter roadmap for WPS Project Management across strategy, opportunity clusters, and solution bets. Use when planning the next quarter's investments.
  - `skills/wps-quarter-roadmap/SKILL.md`
