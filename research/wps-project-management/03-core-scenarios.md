...
`WPS 项目管理` 当前存在 `个人版` 和 `企业版` 两种主要产品环境，因此核心场景的选择不能只看“场景本身”，还要看它主要属于哪种版本环境。
...
- 个人版和企业版不一定共享完全相同的核心场景池
- 同一个“项目管理”场景，在个人版和企业版中的复杂度和价值判断可能完全不同
- 后续做场景优先级排序时，建议明确标注所属版本环境
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 个人版：个人任务与事项推进 | 个人需要持续跟踪多项工作 | 个人用户 | 低 / 中 | 低 | 中 / 高 | 高 | P1 |
| 个人版：轻量项目跟进 | 个人同时推进一个小型项目或目标 | 个人用户、小范围协作者 | 中 | 低 / 中 | 高 | 高 | P1 |
| 企业版：团队项目推进 | 团队启动并执行一个需要多人协作的项目 | 团队负责人、成员 | 中 / 高 | 高 | 高 | 非常高 | P0 |
| 企业版：跨成员分工与同步 | 多人需要围绕共同目标持续协同 | 团队负责人、成员 | 中 | 高 | 高 | 非常高 | P0 |
| 企业版：进度跟踪与管理汇报 | 管理者需要了解项目进展与风险 | 负责人、管理者 | 中 | 中 / 高 | 高 | 高 | P1 |
